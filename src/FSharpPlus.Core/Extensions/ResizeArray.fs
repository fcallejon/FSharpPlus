...
module ResizeArray =
    ...
    let inline map ([<InlineIfLambda>]mapping: 'T->'U) (source: ResizeArray<'T>) = ResizeArray (Seq.map mapping source)
    ...
    let inline map2Shortest ([<InlineIfLambda>]f) (a1: ResizeArray<_>) (a2: ResizeArray<_>) =
