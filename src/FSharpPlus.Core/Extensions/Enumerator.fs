...
module Enumerator =
    ...
    /// [omit]
    let noReset ()         = raise (NotSupportedException "Reset is not supported on this enumerator.")
    ...
    /// <summary>
    /// Returns the nth element in the Enumerator.
    /// </summary>
    /// <remarks>
    ...
    /// Returns an Enumerator comprised of the results <c>x</c> for each element
    ...
    /// <param name="e">The input Enumerator.</param>
    /// <returns>A new Enumerator yielding only elements that satisfy the predicate.</returns>
              ...
              interface IEnumerator with
                  ...
                  member _.MoveNext () =
                      if index.Value = completed then false
                          ...
                          if index.Value = Int32.MaxValue then raise <| InvalidOperationException "Enumeration based on System.Int32 exceeded System.Int32.MaxValue."
