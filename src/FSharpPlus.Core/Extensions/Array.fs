...
module Array =
    ...
    open FSharpPlus.Core.Internals.Errors
    ...
    let inline lift3 ([<InlineIfLambda>]mapping) list1 list2 list3 =
    ...
    /// </returns>
    let inline partitionMap ([<InlineIfLambda>]mapper: 'T -> Choice<'T1,'T2>) (source: array<'T>) =
        raiseIfNull (nameof(source)) source
    ...
    let inline map2Shortest ([<InlineIfLambda>]f) (a1: 'T []) (a2: 'U []) =
